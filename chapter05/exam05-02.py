...
# temp = 0
# total = 0
# for stock_price in stock_prices.keys() :
#   print(stock_prices[stock_price])

# value2 = stock_prices[stock_prices.keys()]

# for key in stock_prices.keys():
#   value = stock_prices[key]
#   # print(sum(value)/len(value))
#   print(f"{key} 평균 주식 가격: {round(sum(value)/len(value), 2)}")
...
# for key in stock_prices.values():
#   print(key)
